...
class Denotation:
    ...
    def __init__(self, exprs, latex=True):
        self.exprs = exprs
        self.latex = latex
        self.verbose = True  # set this to True if you'd like intermediate steps to be printed out, and False otherwise
        self.active = [15]  # set here which denotations to include in the output (see def.s in fnc. 'compute_active')
