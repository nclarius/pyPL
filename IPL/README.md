...
--------
 ...
 - specification of Kripke models (aka interpretations) of PL
 - specification of Kripke structures (aka models) of FOL with domain, interpretation function and variable assignments
